...
class ProformaModel
{
    ...
    public function guardarClienteProforma($cuit, $direccion, $telefono, $email){
        $insert = "INSERT INTO `cliente` (`cuit`, `id_proforma`, `direccion`, `telefono`, `email`) VALUES ('$cuit', NULL, '$direccion', '$telefono', '$email');";
        $this->database->execute($insert);
    }
    ...
    public function guardarCosteoEstimadoProforma($kilometrosEstimado, $combustibleEstimado, $etdCosteoEstimado, $etaCosteoEstimado, $viaticosEstimado, $peajesPesajesEstimado, $extrasEstimado, $hazardEstimado, $reeferEstimado, $feeEstimado, $totalEstimado){
        $insert = "INSERT INTO `costeo_estimado` (`id_costeo_estimado`,`id_proforma`,`km_estimado`,`combustible_estimado`,`etd_estimado`,`eta_estimado`,`viaticos_estimado`,`peajes_estimado`,`extras_estimado`,`hazard_estimado`,`reefer_estimado`,`fee_estimado`,`total_estimado`) VALUES (NULL, NULL,'$kilometrosEstimado','$combustibleEstimado','$etdCosteoEstimado','$etaCosteoEstimado','$viaticosEstimado','$peajesPesajesEstimado','$extrasEstimado','$hazardEstimado','$reeferEstimado','$feeEstimado','$totalEstimado');";
        $this->database->execute($insert);
    }

    public function guardarCosteoRealProforma ($kilometrosReal, $combustibleReal, $etdCosteoReal, $etaCosteoReal, $viaticosReal, $peajesPesajesReal, $extrasReal, $hazardReal, $reeferReal, $feeReal, $totalReal){
        $insert = "INSERT INTO `costeo_real` (`id_costeo_real`,`id_proforma`,`km_real`,`combustible_real`,`etd_real`,`eta_real`,`viaticos_real`,`peajes_real`,`extras_real`,`hazard_real`,`reefer_real`,`fee_real`,`total_real`) VALUES (NULL, NULL,'$kilometrosReal','$combustibleReal','$etdCosteoReal','$etaCosteoReal','$viaticosReal','$peajesPesajesReal','$extrasReal','$hazardReal','$reeferReal','$feeReal','$totalReal');";
        $this->database->execute($insert);
    }
